...
PC1_SERVERS=("172.16.6.61" "10.2.1.2")
PC4_SERVERS=("10.2.2.20" "10.2.2.21" "10.2.2.30")
PC5_SERVERS=("10.2.2.40" "10.2.2.50" "10.2.2.51" "10.2.2.60")
K8S_CP_SERVERS=("10.2.2.2" "10.2.2.3" "10.2.2.4")
K8S_WORKER_SERVERS=("10.2.2.5" "10.2.2.6" "10.2.2.7" "10.2.2.8" "10.2.2.9" "10.2.2.10")
...
case "$MODE" in
    ...
    all)
        ...
        # 1. SSH Keys Deployment
        deploy_key_to_db_via_proxy
        deploy_key_to_list "PC1 (Gateway/WAF)" "${PC1_SERVERS[@]}"
        deploy_key_to_list "PC4 (DB Proxy/Storage)" "${PC4_SERVERS[@]}"
        deploy_key_to_list "PC5 (Ops/Mon/DNS)" "${PC5_SERVERS[@]}"
        deploy_key_to_list "K8S Control Plane" "${K8S_CP_SERVERS[@]}"
        deploy_key_to_list "K8S Workers" "${K8S_WORKER_SERVERS[@]}"
        echo ""
